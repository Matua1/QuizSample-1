...
source = audio.play_file("motivational-day-112790.mp3")
while True:
  continue
  break'''
...
#I will be using the time module to give the user the impression that they are having a conversation with the computer.
  ...
  #  #typewriter effect
    ...
    #name = ""
  # personalising the welcome message so that the user can feel like they are welcome.
    name = input("Please enter your name for this game? ")
    print(chalk.yellow("Welcome", name, "to the Pap High Clean Water Project! You WIN by avoiding 4 WRONG answers."))
    ...
    F                            $$      4$
        ...
        if wrong_answers <= 4:
            typewriter ('Congrats, you win! You guessed correctly ' + str(right_answers) + ' times!')
            replay = input("Please enter yes if you would like to play again? ").lower()
        if replay == "yes":
          main()
        else:
